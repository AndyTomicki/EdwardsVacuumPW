...
Feature: 01 Sublinks specific to the tree
  ...
  - //span[@class='cmp-header-twentytwentyfour__quicklinks-item__link__text' and contains(text(),'Go to webshop')] - expanded shopping cart link
    ...
    Then verify that "//i[@class='fa-kit fa-header-cart']" element is currently visible
    ...
    Then verify that "//span[@class='cmp-header-twentytwentyfour__quicklinks-item__link__text' and contains(text(),'Go to webshop')]" element is currently visible
